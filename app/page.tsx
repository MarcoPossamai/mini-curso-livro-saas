...
export default function Home() {
  return (
    <main>
      <section className="container mx-auto text-center pd-20 px-2 md:px-0">
        ...
        <p className="text-gray-500 mt-4 md:text-xl text-sm max-w-3xl mx-auto">AAAAA</p>
        <form className="mt-10 md:mt-16">
          <div className="flex justify-center gap-2">
            <Input type="email" placeholder="Digite seu e-mail" className="max-w-sm border-gray-300"></Input>
            <Button variant="bg-black">Assine Agora</Button>
          </div>
          <p className="text-xs text-muted-foregorund mt-2">Comece</p>
        </form>
      </section>
      <section>
        <div>
          <h1>Como funciona?</h1>
          <div>
            <Image src={woman} alt="Moça com livros"></Image>
            <ul>
              <li>
      ...
      <section>
        ...
        <footer>
          <Image src={logo} alt="Livro SaaS"></Image>
